...
function generalized_sasaki_nakamura_equation(ddu, du, u, p, rs)
...
function solve_Xinf(s::Int, m::Int, a, omega, lambda, rsin, rsout; reltol=1e-10, abstol=1e-10)
    ...
    odeprob = SecondOrderODEProblem(generalized_sasaki_nakamura_equation, [Xinfprime_rsout], [Xinf_rsout], rsspan, p)
    odealgo = RK4()
